      ...
      console.log(index);
      document.getElementById("icon-empty").innerHTML ='<img src="icon.png"  alt="icon.png"  id="icon1right" class="icon1right"></img>';
      ...
      document.getElementsByClassName("icon-empty")[i].innerHTML='<img src="icon.png" alt="icon.png" id="icon1right" class="icon1right">'+'</img>';
